            ...
            <div class="col-12">
                <table class="table table-responsive table-hover" style="border: 1px dashed #8c8b8b; border-top: 1px dashed #8c8b8b;">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px dashed #8c8b8b;"><center><img src="../uploads/vets_profile_pics/<?php echo $r["profile_pic"] ?>" width="120px;" class="img-responsive img-rounded wow fadeInDown"></center></td>
                        ...
                        <td>
                            <center>
                                <a href="vet_form.php?id=<?php echo $r["id"] ?>" class="btn btn-success">Edit</a>
                                <a href="shared/requests.php?t=vr&id=<?php echo $r["id"] ?>" class="btn btn-danger">Delete</a>
                            </center>
                        </td>
                    </tr>
                    <?php endforeach; ?>
